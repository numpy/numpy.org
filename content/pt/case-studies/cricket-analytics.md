...
{{< figure src="/images/content_images/cs/ipl-stadium.png" caption="**IPLT20, o maior festival de Críquete da Índia**" alt="Copa e estádio da Indian Premier League Cricket" attr="_(Image credits: IPLT20 (cup and logo) & Akash Yadav (stadium))_" attrlink="https\://unsplash.com/@aksh1802" >}}
...
{{< figure src="/images/content_images/cs/cricket-pitch.png" class="csfigcaption" caption="**Pitch de críquete, o ponto focal do campo**" alt="Um pitch de críquete com um boleador e batsmen" align="middle" attr="_(Créditos de imagem: Debarghya Das)_" attrlink="http\://debarghyadas.com/files/IPLpaper.pdf" >}}
...
{{< figure src="/images/content_images/cs/player-pose-estimator.png" class="fig-center" alt="estimador de postura" caption="**Estimador de Postura de Críquete**" attr="_(Créditos de imagem: connect.vin)_" attrlink="https\://connect.vin/2019/05/ai-for-cricket-batsman-pose-analysis/" >}}
