...
_Esta seção resume os pontos mais importantes, mais detalhes podem ser encontrados em_ [Código de Conduta do NumPy - Como dar seguimento a um relatório](/pt/report-handling-manual).
...
4. aplicação de solução via decisão transparente (veja as [Resoluções](/pt/report-handling-manual/#resolucoes)) do Comitê do Código de Conduta.
...
- [O Código de Conduta da SciPy](https://docs.scipy.org/doc/scipy/dev/conduct/code_of_conduct.html)
