...
Finalmente, o Comitê apresentará um relatório ao Conselho Diretor do NumPy (bem como ao time <em x-id="3">core</em> do NumPy no caso de uma resolução em curso, como um banimento).
