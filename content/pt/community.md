...
Nesta lista, por favor, use <em x-id="3">bottom posting</em>, responda à lista (em vez de a outro remetente), e não responda aos <em x-id="3">digests</em>. Um arquivo pesquisável desta lista está disponível [aqui](https://mail.python.org/archives/list/numpy-discussion@python.org/).
