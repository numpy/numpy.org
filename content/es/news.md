...
- Un nuevo asignador de memoria configurable para el uso de proyectos hacia implementaciones derivadas o downstream.

NumPy 1.22.0 es un gran lanzamiento que contó con el trabajo de 153 colaboradores distribuidos sobre 609 solicitudes de incorporación de cambios. Las versiones de Python soportadas por este lanzamiento son
3.8-3.10.
...
_30 de enero de 2021_ -- [NumPy 1.20.0](https://numpy.org/doc/stable/release/1.20.0-notes.html) ya está disponible. Este es el lanzamiento de NumPy más grande hasta la fecha, gracias a los más de 180 colaboradores. Las dos nuevas características nuevas más emocionantes son:
...
### Python 3.9 ya viene, ¿cuándo lanzará NumPy ruedas binarias?
...
día del lanzamiento. Es un esfuerzo importante adaptar la infraestructura de compilación a una versión
nueva de Python y normalmente tarda unas semanas para que los paquetes aparezcan
...
Las ruedas aarch64 están construidas con el último lanzamiento de manylinux2014 que corrige
...
1.17.0, este es un lanzamiento de consolidación. Es la última versión menor que
...
Esta es una lista de lanzamientos de NumPy, con enlaces a las notas del lanzamiento. Los lanzamientos de corrección de errores (solo cambia la `z` en el número de versión `x.y.z`) no tienen nuevas características; las versiones menores (aumenta la `y`) sí las tienen.
